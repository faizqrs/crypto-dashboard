...
1. Clone the repository to your local machine:
   ...
   git clone https://github.com/saptarshree/crypto-dashboard
                             ...
                             CoinChart Component                                     
The CoinChart component is a React-based cryptocurrency chart display component that allows users to visualize cryptocurrency price data over various time intervals. It leverages the Recharts library for rendering interactive and animated charts.
...
Recharts: A charting library built on React components for data visualization.
                      ...
                      CoinExchange Component
The CoinExchange component is a React-based component that allows users to compare the exchange rates between two cryptocurrencies and perform a simple conversion. It is used for visualizing and calculating the exchange rates between selected cryptocurrencies.
...
Usage
Import the CoinExchange component into your React application.
Include the component in your desired React component or route.
...
Redux Integration: Automatically updates the selected currency in the Redux store.
                              ...
                              MainCombine Component
The MainCombine component serves as the main layout for your crypto dashboard application. It integrates various sub-components to provide users with a comprehensive view of cryptocurrency data.

Features
Header: Displays the title "CRYPTO DASHBOARD" in a Green header with a yellow text .
...
CoinChart: Displays cryptocurrency price charts.
PieChart: Shows a pie chart for cryptocurrency portfolio distribution.
CoinExchange: Compares exchange rates for different cryptocurrencies.
RightSidebar: Provides a sidebar for navigation and additional information.
...
Usage
Import the necessary sub-components such as Searchbar, CryptoSidebar, CoinExchange, PieChart, CryptoChart, and CurrencyDropdown.
...
Typing the Coin Name  triggers an API request to CoinGecko.
...
The RightSidebar component is an integral part of a cryptocurrency-related application. It fetches and presents real-time data for the top cryptocurrencies, including market cap, and indicates whether each cryptocurrency is in profit or loss through icons and text. Its integration with Redux ensures data consistency and responsiveness, offering users valuable insights into the cryptocurrency market.